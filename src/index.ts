...
import { handleUpdate, startPolling, registerWebhook, registerCommands, getOrCreateAgent } from './bot';
...
async function main(): Promise<void> {
  ...
  // Initialize agent (syncs tools with correct webhook URLs)
  try {
...
// Handle Bun hot reload - cleanup before module replacement
...
if (import.meta.hot) {
  import.meta.hot.dispose(() => {
    console.log('Hot reload: cleaning up main module...');
    // Bot cleanup is handled in bot.ts
  });
}
