...
- **Other frontend integrations** - We also have [Next.js](https://www.bunjs.com/package/@letta-ai/letta-nextjs), [React](https://www.bunjs.com/package/@letta-ai/letta-react), and [Flask](https://github.com/letta-ai/letta-flask) integrations
...
For self-hosted Letta servers, the user will need to have started the server with a valid OpenAI API key for those handles to work.
...
bun install @letta-ai/vercel-ai-sdk-provider ai

# For agent management (when needed)
bun install @letta-ai/letta-client
